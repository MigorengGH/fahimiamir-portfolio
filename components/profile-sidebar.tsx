  ...
  return (
    <aside className="w-full lg:w-80 bg-card rounded-2xl border border-border p-4 md:p-6 lg:sticky lg:top-8 h-fit">
      ...
      <div className="flex flex-col items-center">
        <div className="relative w-24 h-24 md:w-32 md:h-32 mb-4 md:mb-6 animate-in fade-in zoom-in duration-500">
        ...
        <h1 className="text-xl md:text-2xl font-bold text-foreground mb-1 animate-in fade-in slide-in-from-bottom-2 duration-500 delay-150 fill-mode-both">{data.name}</h1>
        <p className="text-xs md:text-sm text-muted-foreground bg-secondary px-3 md:px-4 py-1 rounded-lg animate-in fade-in slide-in-from-bottom-2 duration-500 delay-200 fill-mode-both">
          {data.title}
        </p>
        ...
        <a
          ...
          className={`mt-4 w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 group animate-in fade-in slide-in-from-bottom-2 duration-500 delay-300 fill-mode-both ${hasResume
      ...
      {/* Divider */}
      <div className="h-px bg-border my-4 md:my-6 animate-in fade-in duration-500 delay-400 fill-mode-both" />

      {/* Contact Info */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-3 md:gap-4 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-500 fill-mode-both">
      ...
      {/* Social Links */}
      <div className="flex items-center justify-center gap-4 mt-4 md:mt-6 pt-4 md:pt-6 border-t border-border animate-in fade-in slide-in-from-bottom-4 duration-500 delay-700 fill-mode-both">
        <a
      ...
      {/* LinkedIn Badge */}
      <div className="mt-6 md:mt-8 w-full hidden md:flex justify-center overflow-hidden rounded-xl animate-in fade-in duration-500 delay-1000 fill-mode-both">
